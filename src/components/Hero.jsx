...
export default function Hero() {
  return (
    <section id="hero" className="h-screen flex flex-col justify-center items-center text-center bg-gradient-to-b from-blue-50 to-white pt-24">
      ...
      >
        <p className="text-lg md:text-xl text-gray-600">
          MSc Computer Networking & Cyber Security Student | Aspiring Data Scientist
        </p>
